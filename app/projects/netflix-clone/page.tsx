...
import image from "public/images/clonenetflix.png";
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center flex flex-col items-center">
                        <div className="mx-auto max-w-2xl lg:mx-0">
                            ...
                            <p className="mt-6 text-md leading-8 text-zinc-300">
                                O projeto consiste na criação de um clone do site da Netflix utilizando a biblioteca
                                Next.js para o desenvolvimento do frontend, Prisma como ORM (Object-Relational Mapping)
                                para interação com o banco de dados, e MongoDB como o banco de dados NoSQL para
                                armazenar dados relacionados ao conteúdo da plataforma.
                            </p>
                            <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                                <div
                                    ...
                                    <a className="_blank" href='https://github.com/GuhhDev/next-netflix'>GitHub
                                        <span className="aria-hidden p-1">→</span>
                                    </a>

                                    <a className="_blank" href='https://super-netflix.netlify.app/auth'>Website
                                        <span className="aria-hidden p-1">→</span>
                                    </a>
                                </div>
                            </div>
